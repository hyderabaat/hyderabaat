...
<body>
    ...
    <div>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/coverpage.jpg" style="top: 299px; left: 17px; position: absolute; height: 600px; width: 400px;" Height="500px" Width="400px" />
       <asp:Image ID="Image11" runat="server" ImageUrl="~/images/coverstory1.jpg" style="top: 299px; left: 447px; position: absolute; height: 600px; width: 400px;" Height="500px" Width="400px" />
        <asp:Image ID="Image12" runat="server" ImageUrl="~/images/coverstory2.jpg" style="top: 299px; left: 855px; position: absolute; height: 600px; width: 400px;" Height="500px" Width="400px" />
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/page2.aspx" style="z-index: 1; left: 680px; top: 284px; position: absolute">4</asp:HyperLink>
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/page2.aspx" style="z-index: 1; left: 698px; top: 284px; position: absolute">5</asp:HyperLink>
        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/page2.aspx" style="z-index: 1; left: 720px; top: 284px; position: absolute">6</asp:HyperLink>
        <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/page2.aspx" style="z-index: 1; left: 707px; top: 904px; position: absolute">4</asp:HyperLink>
        <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/page2.aspx" style="z-index: 1; left: 724px; top: 904px; position: absolute">5</asp:HyperLink>
        <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/page2.aspx" style="z-index: 1; left: 740px; top: 904px; position: absolute">6</asp:HyperLink>
    </form>
</body>
</html>
