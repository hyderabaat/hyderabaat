...
<body>
    ...
    <div>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/telugupage2.JPG" style="top: 299px; left: 17px; position: absolute; height: 600px; width: 400px;" Height="500px" Width="400px" />
       <asp:Image ID="Image11" runat="server" ImageUrl="~/images/urdupage1.JPG" style="top: 299px; left: 447px; position: absolute; height: 600px; width: 400px; right: 377px;" Height="500px" Width="400px" />
        <asp:Image ID="Image12" runat="server" ImageUrl="~/images/urdupage2.jpg" style="top: 299px; left: 855px; position: absolute; height: 600px; width: 400px;" Height="500px" Width="400px" />
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/page5.aspx" style="z-index: 1; left: 677px; top: 284px; position: absolute">13</asp:HyperLink>
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/page5.aspx" style="z-index: 1; left: 698px; top: 284px; position: absolute">14</asp:HyperLink>
        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/page5.aspx" style="z-index: 1; left: 720px; top: 284px; position: absolute">15</asp:HyperLink>
        <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/page5.aspx" style="z-index: 1; left: 710px; top: 904px; position: absolute">13</asp:HyperLink>
        <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/page5.aspx" style="z-index: 1; left: 731px; top: 904px; position: absolute">14</asp:HyperLink>
        <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/page5.aspx" style="z-index: 1; left: 750px; top: 904px; position: absolute">15</asp:HyperLink>

        <asp:HyperLink ID="HyperLink9" runat="server" NavigateUrl="~/page5.aspx" style="z-index: 1; left: 770px; top: 284px; position: absolute" ToolTip="Next">></asp:HyperLink>
        <asp:HyperLink ID="HyperLink10" runat="server" NavigateUrl="~/page4.aspx" style="z-index: 1; left: 627px; top: 284px; position: absolute"  ToolTip="Previous"><</asp:HyperLink>
        <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/page5.aspx" style="z-index: 1; left: 670px; top: 904px; position: absolute" ToolTip="Previous"><</asp:HyperLink>
